#Membuat object dari class str #merupakan class bawaan python
kata = "suryani elmaghfiroh" 
...
print (kata.split()) #berdaasarkan wedpash spasi 

#Mengembalikan sebuah list yang menyimpan item dari string, yang dipisahkan oleh karakter "l"
print (kata.split("a")) #("a") bisa diganti apa saj amisal - w y itu gunany amenghilangkan namanya 
...
print ("-".join(kata)) #"-" bisa diganti dengan apapuun misal % akan muncul di setiap kata
